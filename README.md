...
# Software for Nomis App telegram Bot
...
3. Configure the application:
  ...
  And don't forget set your referral code 
  ```python
  REFERRAL_CODE = "ref_SpmeVi1tSP"
  ```
  
  And you can edit set your referral code 
  ```python
  START_SLEEP = [30,60]
  TASKS_SLEEP = [20,40]
  END_SLEEP = [5000,10000]
  MINI_SLEEP = [1,20]
  ```
  For example END_SLEEP it is random sleep time from 5000 to 10000 seconds
...
Thank you for using NomisApp Telegram Bot! Don't forget to follow our [Telegram channel](https://t.me/petyasofts) for updates.
